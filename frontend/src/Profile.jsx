        ...
        <div className="min-h-screen bg-[#fffef2] text-navy font-sans selection:bg-lime/30 flex flex-col overflow-x-hidden">
            ...
            <main className="flex-1 flex items-center justify-center p-4 pt-32">
                ...
                >
                    ...
                    <h1 className="text-4xl font-extrabold text-navy mb-4">Profile Settings</h1>
                    <p className="text-slate-600 mb-8 leading-relaxed">
                        We're currently building your personalized profile dashboard. Soon you'll be able to manage your account, preferences, and avatars here.
                    </p>
                    <Link to="/home">
