      ...
      <main className="pt-32 pb-20 px-4 flex-1 flex flex-col items-center justify-center min-h-[70vh]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight text-navy">Leaderboard</h1>
            ...
            <p className="mt-8 text-slate-500 max-w-lg mx-auto">
              We're currently building the ranking system to help you track your performance against peers in the Algorithmist DSA classes.
            </p>
          </motion.div>
        </div>
      </main>
